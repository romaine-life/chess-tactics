...
export function installTestDrawableCatalog() {
  applyDrawableCatalog({
    ...
    updatedAt: null,
    assets: [
      { id: 'terrain-family-grass', kind: 'terrain-family', label: 'Grass', sortOrder: 0, lifecycleState: 'active', behavior: { value: 'grass', default: true, roles: ['level-editor-scatter'], scatterDefaultShare: 100 }, metadata: {}, rowRevision: 1, media: {} },
      { id: 'terrain-family-dirt', kind: 'terrain-family', label: 'Dirt', sortOrder: 1, lifecycleState: 'active', behavior: { value: 'dirt', roles: [] }, metadata: {}, rowRevision: 1, media: {} },
      { id: 'terrain-family-sand', kind: 'terrain-family', label: 'Sand', sortOrder: 2, lifecycleState: 'active', behavior: { value: 'sand', roles: [] }, metadata: {}, rowRevision: 1, media: {} },
      { id: 'terrain-family-stone', kind: 'terrain-family', label: 'Stone', sortOrder: 3, lifecycleState: 'active', behavior: { value: 'stone', roles: [] }, metadata: {}, rowRevision: 1, media: {} },
