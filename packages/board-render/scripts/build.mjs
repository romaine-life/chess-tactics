...
for (const name of ['levelRenderPlan', 'boardHashForLevel', 'levelThumbnailMediaSlots', 'hydratePropSeats', 'applyLiveMediaCatalog', 'applyServerRenderSnapshot', 'boardDrawOps', 'boardPreviewFramingBounds', 'cameraToContainBounds', 'buildPredrawnGenerationDefinition', 'playRouteScreenName', 'unitAssetProductionEligibility']) {
