...
for (const name of ['levelRenderPlan', 'boardHashForLevel', 'applyPropSeatOverrides', 'boardDrawOps', 'boardSocialFramingBounds', 'playRouteScreenName', 'unitAssetProductionEligibility']) {
