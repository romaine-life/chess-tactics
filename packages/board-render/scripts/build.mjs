...
for (const name of ['levelRenderPlan', 'boardHashForLevel', 'hydratePropSeats', 'applyLiveMediaCatalog', 'applyServerRenderSnapshot', 'boardDrawOps', 'boardPreviewFramingBounds', 'cameraToContainBounds', 'buildPredrawnGenerationDefinition', 'playRouteScreenName', 'unitAssetProductionEligibility']) {
