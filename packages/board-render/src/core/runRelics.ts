const RUN_RELIC_REGISTRY = [
  ...
  { id: 'inspirational-record', name: 'Dawn Register', description: 'Before each Battle, one random persistent unit gains Discipline for that Battle.', flavorText: 'Before each departure, a different name was read.' },
  { id: 'training-linens', name: 'Field Linens', description: 'Your Pawns gain Positioned.', flavorText: 'The sheets dried before the road did.' },
