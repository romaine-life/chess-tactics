...
export function testDrawableCatalog(ids: readonly string[] = ['earth', 'roots', 'bedrock']): DrawableCatalog {
  ...
  const appUiRoles = [
    ...
    'ui-kit-icons-game-plagued-png',
    'ui-kit-icons-game-positioned-png',
    'ui-kit-icons-game-discipline-png',
    'ui-kit-icons-game-marshalled-png',
    'ui-kit-icons-card-properties-pestiferous-png',
    'ui-kit-icons-card-properties-concinnous-png',
    'ui-kit-icons-card-properties-tactical-png',
    'ui-kit-icons-card-properties-hieratic-png',
