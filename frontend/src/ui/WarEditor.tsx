    ...
    <>
      ...
      {selectedLevel && selectedWar ? (
        <LevelPreviewColumn
          ...
          embedded={embedded}
          verbs={[
            { id: 'edit', label: 'Edit Board', to: editBattleBoardHref(selectedWar.id, selectedLevel.id) },
            { id: 'test', label: 'Test Play', to: `/play?levelId=${encodeURIComponent(selectedLevel.id)}&mode=test&returnTo=${encodeURIComponent(WAR_EDITOR_RETURN_TO)}` },
          ]}
        />
      ) : null}
    </>
