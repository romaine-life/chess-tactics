...
describe('Run chrome hierarchy', () => {
  ...
  // the same confirmation Start New Run uses for replacing an active Run (ADR-0571/0584). No
  ...
  // frame at either end (ADR-0242/0571/0584).
  ...
  // body text surviving its dialog, and it goes with the dialog (ADR-0584). The QUESTION is still
