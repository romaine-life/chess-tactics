 ...
 */
export const MENU_ICON_BATCH_ID = 'main-menu-icons-2026-08-09';
    ...
    >
      <OuterChromeBox chromeConsumer="menu-icon-review" titled className="menu-icon-review-panel">
        ...
        <p>
          ...
          is fitted the same way: its ink scaled until the long axis is exactly 52 of the
          64px canvas, then centred on both axes, so the set reads at one size and one
          centre line. Nothing is installed until you install a set.
        </p>
