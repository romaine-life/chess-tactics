...
describe('Campaign Editor recent draft row', () => {
  it('is one full-size navigable level card with its private working-copy thumbnail and controls', () => {
    ...
    expect(markup).toContain('data-chrome-unit="inner-box" class="inner-box inner-chrome-box has-chrome-surface-fill chrome-divided-grid ce-editor-level-row-box ce-editor-level-row is-neutral"');
