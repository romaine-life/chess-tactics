...
const MANUBIUM_EXAMPLE: Readonly<Record<ManubiumId, ManubiumExample>> = {
  ...
  'knight-fork': {
    // Three prongs the enemy cannot answer: the King, which must move, and a Rook and a Bishop
    // that nothing of theirs defends — so the check buys the free move that collects one of them.
    // Nothing on the board reaches the square the Knight landed on either. The marked empty
