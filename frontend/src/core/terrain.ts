// Terrain movement effects (issue #44 Track 4): cliffs/rocks/voids block movement and
...
// Tiles a piece can never stand on. Water is just a board surface; `cliff`, `rock`,
// and `void` are the blocking terrain families.
