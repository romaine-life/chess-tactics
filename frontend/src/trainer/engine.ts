...
export { generateOpeningBook, generateCuratedBook, positionBalance } from '../game/openingBook';
export type { BookPosition, OpeningBookSettings, CurationSettings } from '../game/openingBook';
export { splitBook } from '../lab/openingBooks';
...
// Board solver shared contracts (ADR-0068). Only the `const` arrays/helpers are runtime;
...
// Board solver runtime (Phase 3, ADR-0068). The callable engine the cluster solve-worker
