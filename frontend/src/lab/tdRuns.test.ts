...
import { freshTdSession, upsertTdRun, type TdAdoptionRecord, type TdRunsDoc, type TdSessionDoc } from './tdSession';
import { migrateTdRuns, type BooksBlob } from './openingBooks';
...
describe('migrateTdRuns', () => {
  ...
  it('wraps the retired tdSession field as Run 1 (contents intact) and drops the field', () => {
