...
export function sceneBoardForSkirmish(
  ...
  return {
    ...
    // Which of those anchors stand ON a plate rather than being painted into it (ADR-0537). The
...
export function SkirmishBoard({
   ...
   *  cursor. Left unset, the board takes its own premove chain back (ADR-0549). */
  ...
  // ...and so does a right click on the board (ADR-0549), which is the gesture a chess player
