...
//
// `--want` narrows the search to one entry — `advantageous-capture`, `capture-with-check`,
// `knight-fork`, `royal-fork`, `humble-mate`, `discovered-check`, `double-check`, `en-passant`,
// `smothered-mate`, `promotion-mate` — for
