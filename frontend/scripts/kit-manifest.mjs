...
const frameNames = ['panel', 'row', 'button-neutral', 'button-primary', 'button-danger', 'tab-active', 'tab-inactive', 'field-input', 'field-select', 'icon-button', 'icon-button-active', 'toggle-track', 'toggle-knob', 'divider'];
