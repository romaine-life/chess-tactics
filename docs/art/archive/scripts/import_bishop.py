...
FBX = glob.glob(os.path.join(os.environ["TEMP"], "bishop_extract", "source", "rar", "**", "*.fbx"), recursive=True)[0]
...
ob=bpy.context.view_layer.objects.active; ob.name="bishop"
...
s.render.image_settings.file_format="PNG"; s.render.filepath=os.path.join(OUT,"bishop_south")
bpy.ops.render.render(write_still=True)
bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT,"bishop_base.blend"))
print("rendered bishop_south.png")
