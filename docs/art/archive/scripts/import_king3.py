...
OBJ = glob.glob(os.path.join(os.environ["TEMP"], "king3_extract", "**", "*.obj"), recursive=True)[0]
...
bpy.ops.object.transform_apply(location=True, rotation=True, scale=True)  # bake import axis-conversion
def co():
...
s.render.image_settings.file_format="PNG"; s.render.filepath=os.path.join(OUT,"king3_south")
bpy.ops.render.render(write_still=True)
bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT,"king_base.blend"))
print("rendered king3_south.png ; saved king_base.blend")
