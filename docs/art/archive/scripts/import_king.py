...
OBJ = os.path.join(os.environ["TEMP"], "king_extract", "source", "rey", "rey.obj")
...
s.render.image_settings.file_format="PNG"; s.render.filepath=os.path.join(OUT,"king_current_south")
bpy.ops.render.render(write_still=True)
print("rendered king_current_south.png")
