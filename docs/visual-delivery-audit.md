...
[ADR-0136](adr/0136-loading-is-manifest-driven-and-frame-acknowledged.md).
...
ADR-0136 to specify that a canonical runtime path includes a bounded manifest and that
