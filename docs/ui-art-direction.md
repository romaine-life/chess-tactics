...
Per [ADR-0435](adr/0435-expunctio-is-a-card-first-gallery.md), Expunctio is a
...
Per [ADR-0436](adr/0436-athetize-is-the-card-action-within-expunctio.md), the
...
Per [ADR-0437](adr/0437-expunctio-card-tiles-remain-opaque-in-every-state.md),
...
Per [ADR-0438](adr/0438-card-companions-align-to-painted-frame-keylines.md),
...
Per [ADR-0439](adr/0439-expunctio-tiles-use-shell-surface-and-oak-actions.md),
...
Per [ADR-0441](adr/0441-expunctio-scrollbar-keys-to-the-terminal-frame-rail.md),
