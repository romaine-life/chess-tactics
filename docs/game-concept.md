...
- A fresh Run opens in the normal Shop with the permanent King, two free Pawns,
  ...
  noun for these deck entries and offers (ADR-0306, ADR-0307, ADR-0308).
...
Player armies and Run progression are governed by ADR-0193. ADR-0306 makes the
opening the normal Shop transaction and retires the separate draft phase and
screen. ADR-0307 supplies the current two-Pawn, 8-gold opening and card-native
purchase language, feedback, and sound. ADR-0308 removes the inherited
