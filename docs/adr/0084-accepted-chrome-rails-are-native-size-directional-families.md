...
Chrome Lab exposed a useful source-scale readout after ADR-0083. That readout
...
- Amends [ADR-0083](0083-chrome-frame-geometry-is-derived-not-authored-state.md):
