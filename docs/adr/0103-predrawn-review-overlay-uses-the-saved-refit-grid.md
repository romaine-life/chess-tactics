...
partially_supersedes: "[ADR-0102](0102-predrawn-refit-target-dimensions-are-owner-configurable.md)"
---

# ADR-0103: Pre-drawn review overlay uses the saved refit grid

## Context

ADR-0102 made the artwork refit target dimensions owner-configurable while
