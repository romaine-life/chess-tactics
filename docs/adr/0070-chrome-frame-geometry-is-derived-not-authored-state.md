...
# ADR-0070: Chrome frame geometry is derived, not authored state
...
divider may bridge those boundaries according to ADR-0069, but they may not
...
- Amends [ADR-0068](0068-empty-control-panel-frames-are-overlays-not-layout-borders.md)
  by making Fill Box and Contents Box direct authored boundaries.
- Amends [ADR-0069](0069-control-panel-chrome-has-outer-and-inner-roles.md)
...
- Amended by [ADR-0071](0071-accepted-chrome-rails-are-native-size-directional-families.md):
