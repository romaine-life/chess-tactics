---
status: "accepted; fixed authored-dimension target superseded by ADR-0111; production emits an immutable raster child under ADR-0158"
date: 2026-07-13
...
partially_superseded_by: "[ADR-0111](0111-predrawn-refit-target-dimensions-are-owner-configurable.md) and [ADR-0158](0158-immutable-predrawn-background-versions-own-derived-raster-and-occlusion.md)"
---
