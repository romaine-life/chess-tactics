...
partially_superseded_by:
  - "[ADR-0308](0308-run-shops-allow-every-affordable-card-purchase.md)'s multi-card shared Shop transaction and format-10 purchase state"
  - "[ADR-0307](0307-run-openings-use-two-pawns-eight-gold-and-card-native-purchase-feedback.md)'s format-9 card vocabulary, two-Pawn army, eight-gold budget, and purchase feedback"
partially_supersedes:
  ...
  - "[ADR-0304](0304-run-openings-spend-nine-gold-on-one-of-three-seeded-cards.md)'s opening-specific one-step purchase transaction"
  - "[ADR-0305](0305-run-openings-begin-with-only-the-permanent-king.md)'s draft-phase normalization"
extends:
  - 0230-run-shops-separate-buying-army-inspection-and-selling.md
  - 0304-run-openings-spend-nine-gold-on-one-of-three-seeded-cards.md
  - 0305-run-openings-begin-with-only-the-permanent-king.md
---

# ADR-0306: Run opening is the normal Shop and draft is retired
...
- The opening Shop starts with the permanent King, 9 gold, and the three seeded
  distinct-valued standard Units offers governed by ADR-0304/0305.
...
- [ADR-0304](0304-run-openings-spend-nine-gold-on-one-of-three-seeded-cards.md)
- [ADR-0305](0305-run-openings-begin-with-only-the-permanent-king.md)
