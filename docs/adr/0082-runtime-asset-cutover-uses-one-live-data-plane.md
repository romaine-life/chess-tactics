...
# ADR-0082: Runtime asset cutover uses the one live app data plane

## Context

ADR-0081 correctly moved media ownership from Git to Postgres pointers plus
...
This supersedes only ADR-0081's implication that a production-seeded test-slot
