...
# ADR-0453: A terminal Run Battle is a craftable review landing

## Context

ADR-0452 makes the won board itself a distinct product surface: the settled position remains
...
- The Run battlefield waits until that exact match has mounted and its board surface has painted,
  ...
  The player lands directly on ADR-0452's visible-board Victory state without a placeholder-board
