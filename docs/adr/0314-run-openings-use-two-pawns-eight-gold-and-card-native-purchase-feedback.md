...
partially_superseded_by:
  - "[ADR-0315](0315-run-shops-allow-every-affordable-card-purchase.md)'s independently purchasable cards and format-10 purchase collection"
partially_supersedes:
  - "[ADR-0224](0224-owner-supplied-sfx-open-as-full-source-trim-instruments.md)'s dedicated card-purchase runtime cue"
  - "[ADR-0311](0311-run-openings-spend-nine-gold-on-one-of-three-seeded-cards.md)'s nine-gold budget, 1–9 opening range, and all-core-cards-reachable outcome"
  - "[ADR-0312](0312-run-openings-begin-with-only-the-permanent-king.md)'s King-only pre-purchase party"
  - "[ADR-0313](0313-run-opening-is-the-normal-shop-and-draft-is-retired.md)'s current transaction vocabulary and format-8 shape"
extends:
...
# ADR-0314: Run openings use two Pawns, eight gold, and card-native purchase feedback

## Context and Problem Statement

The normal opening Shop established by ADR-0313 made a purchase remain visible,
