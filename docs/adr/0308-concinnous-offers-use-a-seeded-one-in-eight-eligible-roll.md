...
extends:
  ...
  - "[ADR-0307](0307-concinnous-names-the-white-positioned-card-qualifier.md)"
---

# ADR-0308: Concinnous offers use a seeded one-in-eight eligible roll

## Context

ADR-0307 fixes the Concinnous mechanic and semantic identity but deliberately
