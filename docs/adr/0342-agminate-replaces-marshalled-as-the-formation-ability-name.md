...
partially_supersedes:
  ...
  - "[ADR-0338](0338-run-card-properties-and-unit-states-use-paired-icons.md)'s Hieratic/Marshalled pair name"
  - "[ADR-0339](0339-run-card-icon-fitting-is-an-owner-operated-studio-instrument.md)'s Marshalled fitting label"
---

# ADR-0342: Agminate replaces Marshalled as the formation-ability name
...
- The persisted runtime value `marshalled` and live-media source slot
  ...
  identities until ADR-0338's deferred atomic paired-icon production cutover.
