...
- Completed by [ADR-0064](0064-homepage-backdrop-is-one-continuous-instance.md): §G promised the
  homepage **scene** and rain were both continuous, but only the rain was — the scene re-mounted
  per screen. ADR-0064 makes the scene one re-parented instance too, closing the gap.
