---
status: "accepted; separate Apply transaction superseded by ADR-0098; corner-only instrument superseded by ADR-0101"
date: 2026-07-13
deciders: Nelson, Codex
partially_supersedes: "[ADR-0096](0096-predrawn-candidate-review-uses-exact-board-plane-registration.md)"
partially_superseded_by: "[ADR-0098](0098-predrawn-registration-has-no-unsaved-dialog-state.md) and [ADR-0101](0101-owner-fitted-grid-defines-predrawn-review-rectification.md)"
---

# ADR-0097: Pre-drawn registration is owner-picked source geometry

## Context

ADR-0096 made whole-plate registration exact once four source corners were known,
...
The exact whole-image homography from ADR-0096 remains the registration operation;
per-object and per-cell correction remain forbidden.

Production acceptance remains governed by ADR-0076 and ADR-0096: registration is
