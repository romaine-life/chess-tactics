...
partially_superseded_by:
  - "[ADR-0339](0339-run-card-properties-and-unit-states-use-paired-icons.md)'s replacement of visible qualifier suffixes with right-side property icons and reassignment of forged steel from white Concinnous to Hieratic"
